...
if ios:
    ...
    run("mkdir mobile/android/app/src/main/jniLibs/")
    run("mkdir mobile/android/app/src/main/jniLibs/arm64-v8a")
    run("mkdir mobile/android/app/src/main/jniLibs/armeabi-v7a")
    run("mkdir mobile/android/app/src/main/jniLibs/x86")
