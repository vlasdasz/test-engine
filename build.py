...
def build_android():
    ...
    run("cargo build --target aarch64-linux-android --lib")
    ...
    try:
        os.symlink(this_path + "/target/aarch64-linux-android/debug/libtest_game.so", "mobile/android/app/src/main/jniLibs/arm64-v8a/libtest_game.so")
