...
impl ValidRule {
    fn check_min<T: Reflected>(min: usize, obj: &T, field: &Field) -> ValidResult<()> {
    ...
    fn check_max<T: Reflected>(max: usize, obj: &T, field: &Field) -> ValidResult<()> {
    ...
    fn check_range<T: Reflected>(min: usize, max: usize, obj: &T, field: &Field) -> ValidResult<()> {
    ...
    fn check_equals<T: Reflected>(other_field: &Field, obj: &T, field: &Field) -> ValidResult<()> {
