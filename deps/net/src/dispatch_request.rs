...
//     _request: Request<Param, Result>,
// }
//
// impl<R, P> DispatchRequest<R, P> {
//     pub fn make(url: &'static str) -> Self {
//         Self {
//             _request: Request::make(url),
//         }
//     }
// }
//
// impl<Result: DeserializeOwned + Default + Sync + Send> DispatchRequest<(),
// Result> {     pub fn get<Obj: 'static>(
//         &'static self,
//         obj: &Obj,
//         completion: impl FnOnce(Weak<Obj>, Option<Error>, Result) + Send +
// 'static,     ) {
//         // let weak = obj.weak();
...
//         // Dispatch::dispatch(self.request.post(param), move |result| match
//         // result {     Ok(_) => completion(rglica.deref_mut(), None),
//         //     Err(err) => {
//         //         error!("{err}");
...
//         param: impl Borrow<Param> + Send + 'static,
//         obj: &Obj,
//         _completion: impl FnOnce(&mut Obj, Option<Error>, Result) + Send +
// 'static,     ) {
//         // let mut rglica = obj.weak();
//         // Dispatch::dispatch(self.request.fetch(param), move |response|
// match         // response {     Ok(val) => completion(rglica.deref_mut(),
//         // None, val),     Err(err) => {
//         //         error!("{err}");
//         //         completion(rglica.deref_mut(), err.into(),
//         // Result::default());     }
