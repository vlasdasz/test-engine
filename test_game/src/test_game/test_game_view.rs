...
// };
// use ui_views::{test_view::ViewWithCat, AnalogStickView, Button, DPadView,
// IntView};
//
// #[view]
...
//             .on_press
//             .val(|dir|
// UILayer::get().level.as_mut().unwrap().player().move_by_direction(&dir));
//     }
//
...
//         self.level_scale
//             .on_change(|val|
// UILayer::get().level.as_mut().unwrap().set_scale(val));
//
//         {
