use anyhow::Result;
use test_engine::{
    AppRunner, dispatch::from_main, inspect::views::PlacerView, refs::Weak, ui::{Container, Setup, TURQUOISE, UI, UIManager, ViewData, ViewFrame, view}, ui_test::record_ui_test
};
