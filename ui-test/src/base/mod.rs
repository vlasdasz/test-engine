use crate::base::{
    ...
    present::test_navigation_view, root_view::test_root_view, selection::test_selection, styles::test_styles,
    template::test_template, text_occlusion::test_text_occlusion, touch_order::test_touch_order,
    touch_stack::test_touch_stack, transition::test_transition, transparency::test_transparency,
