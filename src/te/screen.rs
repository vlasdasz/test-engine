...
impl Updatable for Screen {
    ...
    fn init(&mut self) {
        ...
        let mut view = ViewBase::from_rect(Rect::make(100.0, 100.0, 200.0, 200.0));

        //view.add_subview(make_box(ViewBase::from_rect(Rect::make(50.0, 50.0, 50.0, 50.0))));

        self.root_view.add_subview(make_box(view));


        let mut view = ViewBase::from_rect(Rect::make(50.0, 50.0, 50.0, 50.0));

        self.root_view.subviews().last_mut().unwrap().add_subview(make_box(view));
